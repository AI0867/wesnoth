...
env = Environment(tools=["tar", "test_gettext", "install", "python_devel", "scanreplace"], options = opts, toolpath = toolpath)
...
configure_args = dict(
    custom_tests = init_metasconf(env, ["ieee_754", "cplusplus", "python_devel", "sdl", "boost", "cairo", "pango", "pkgconfig", "test_gettext", "lua"]),
